...
$RootCache = CacheFactory::createRedisCache('key_03', Cache::getClass(), $Connection);
$Level2Cache = CacheFactory::createRedisCache('key_03', Level2Cache::getClass(), $Connection);
$Level3Cache = CacheFactory::createRedisCache('key_03', Level3Cache::getClass(), $Connection);
